...
```sh
  cd your-folder
  git clone https://github.com/yash244466666/Hello-Rails-and-React.git
```
...
Feel free to check the [issues page](https://github.com/yash244466666/Hello-Rails-and-React/issues).
